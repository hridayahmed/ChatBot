package com.hridha.chatbot.Adapter;
...
import com.hridha.chatbot.Models.ChatModel;
import com.hridha.chatbot.R;

import java.util.List;

/**
 * Created by hrida on 8/13/2017.
 */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null)
        {
            if(list_chat_models.get(position).isSend)
                view = layoutInflater.inflate(R.layout.activity_list_item_message_send,null);
            else
                view = layoutInflater.inflate(R.layout.activity_list_item_message_recv,null);
